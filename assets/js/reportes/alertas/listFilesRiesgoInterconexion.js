console.log("listFilesRiesgoInterconexion.js funcionando");
...
function fetchRiesgoInterconexion(carpetaReportes) {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            const categorias = {
                baseCalRankTot: {
                    archivos: data.filter(item => item.name.includes('ranking total')),
                    tablaId: 'rTBodyBaseCalRankTot'
                },
                interconexion: {
                    archivos: data.filter(item => item.name.includes('interconexion')),
                    tablaId: 'rTBodyInterconexion'
                },
            };
...
document.addEventListener("DOMContentLoaded", () => {
    if (typeof carpetaReportes !== 'undefined') {
        fetchRiesgoInterconexion(carpetaReportes);
    } else {
