console.log("listFilesCalidadActivos.js funcionando");
...
function fetchCalidadActivos(carpetaReportes) {
...
document.addEventListener("DOMContentLoaded", () => {
    if (typeof carpetaReportes !== 'undefined') {
        fetchCalidadActivos(carpetaReportes);
    } else {
