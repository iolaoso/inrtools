console.log("listFilesCalidadResultados.js funcionando");
...
// Función Principal
function fetchCalidadResultados(carpetaReportes) {
...
document.addEventListener("DOMContentLoaded", () => {
    if (typeof carpetaReportes !== 'undefined') {
        fetchCalidadResultados(carpetaReportes);
    } else {
