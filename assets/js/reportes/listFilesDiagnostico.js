console.log("listFilesDiagnostico.js funcionando");
...
function fetchReportsDiag(carpetaReportes) {
    const url = `${baseurl}/backend/reportes/listFilesReportesDiag.php?carpeta=${encodeURIComponent(carpetaReportes)}`;
