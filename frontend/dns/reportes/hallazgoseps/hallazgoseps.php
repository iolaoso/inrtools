...
<body>
    ...
    <div class="d-flex">
        ...
        <main class="content p-3" id="main-content">
            <div class="row align-items-center mb-1">
                <h1 class="display-6 tituloPagina">Hallazgos EPS</h1>
                <p>Reporte de los informes de seguimeinto de la EPS</p>
            </div>
    ...
    <script>
        ...
        const carpetaReportes = 'assets/files/reportes/hallazgoseps';
    </script>
