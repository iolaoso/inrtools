...
<body>
    ...
    <div class="d-flex">
        ...
        <main class="content p-3" id="main-content">
            <div class="row align-items-center mb-1">
                <h1 class="display-6 tituloPagina">Auditores Externos</h1>
                <p>Reporte de Informes de Auditoria Externa</p>
            </div>
    ...
    <script>
        ...
        const carpetaReportes = 'assets/files/reportes/aexternos';
    </script>
