...
<body>
    ...
    <div class="d-flex">
        ...
        <main class="content p-3" id="main-content">
            <div class="row align-items-center mb-1">
                <h1 class="display-6 tituloPagina">Diagnósticos Situacionales</h1>
                <p>Reporte de los informes de tipo diagnóstico situacional</p>
            </div>
                    ...
                    <div class="card h-100 d-flex flex-column border-secondary">
                        ...
                        <div class="card-body">
                            <div class="table-container" style="max-height: 300px; overflow-y: auto;">
                                <div class="table table-striped table-sm" style="font-size: 12px;" id="tablaRepBrechas">
    ...
    <script>
        ...
        const carpetaReportes = 'assets/files/reportes/diagsituacional';
    </script>
