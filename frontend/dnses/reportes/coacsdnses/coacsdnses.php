...
<body>
    ...
    <div class="d-flex">
        ...
        <main class="content p-3" id="main-content">
            <div class="row align-items-center mb-1">
                <h1 class="display-6 tituloPagina">REPORTE COACS DNSES</h1>
                <p>Alertas relacionadas con las Entidades del SF.</p>
            </div>
    ...
    const carpetaReportes = 'assets/files/reportes/coacsdnses';
    </script>
    <script src="<?php echo $base_url; ?>/assets/js/reportes/listarArchivosVersion.js"></script>
</body>
