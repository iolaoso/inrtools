...
<body>
    ...
    <div class="d-flex">
        ...
        <main class="content p-3" id="main-content">
            <div class="row align-items-center mb-1">
                <h1 class="display-6 tituloPagina">Variaciones B11</h1>
                <p>Reportes de Variaciones de las cuentas de balances (B11) mensuales del SFPS</p>
            </div>
    ...
    const carpetaReportes = 'assets/files/reportes/variacionesb11';
    </script>
