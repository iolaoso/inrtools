    ...
    <div class="d-flex">
        ...
        <main class="content p-3" id="main-content">
            <div class="row align-items-center mb-1">
                <h1 class="display-6 tituloPagina">Ind Ranking Preliminar (INSESF)</h1>
                <p>Base de datos de coacs y mutualistas activas preliminar para la Intendencia Nacional de Supervisión a Entidades del Sector Financiero Popular y Solidario (INSESF) que contiene: variables de identificación, cuentas contables del CUC e indicadores financieros específicos.
</p>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card h-100 d-flex flex-column border-secondary">
                        <div class="card-header text-white" style="background-color: #05829bff;">
                            <h4>1. Ind Ranking COACS Y MUTUALISTAS Preliminar INSESF (EXCEL)</h4>
                            <em>Base de datos de coacs y mutualistas activas preliminar para INSESF que contiene: variables de identificación, cuentas contables del CUC e indicadores financieros específicos.</em>
                        </div>
                        <div class="card-body">
