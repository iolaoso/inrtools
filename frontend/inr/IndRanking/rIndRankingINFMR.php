    ...
    <div class="d-flex">
        ...
        <main class="content p-3" id="main-content">
            <div class="row align-items-center mb-1">
                <h1 class="display-6 tituloPagina">Ind Ranking INFMR</h1>
                ...
                <div class="col-md-12">
                    <div class="card h-100 d-flex flex-column border-secondary">
                        <div class="card-header text-white" style="background-color: #05829bff;">
                            <h4>1. Cuentas e indicadores último balance coacs y mutualistas INFMR (EXCEL)</h4>
                            <em>Base de cuentas e indicadores financieros con el último balance de coacs y mutualistas.</em>
                        </div>
                        <div class="card-body">
