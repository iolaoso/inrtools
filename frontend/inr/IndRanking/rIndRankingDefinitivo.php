    ...
    <div class="d-flex">
        ...
        <main class="content p-3" id="main-content">
            <div class="row align-items-center mb-1">
                ...
                <p>Base de datos definitiva que contiene: variables de identificación, cuentas contables del CUC, indicadores financieros; promedios por segmento, benchmark y tipo; y calificación de riesgo.</p>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card h-100 d-flex flex-column border-secondary">
                        <div class="card-header bg-info text-white">
                            ...
                            <em>Base de datos histórica de coacs definitiva que contiene: variables de identificación, cuentas contables del CUC, indicadores financieros; promedios por segmento, benchmark y tipo; y calificación de riesgo.</em>
                        </div>
                        <div class="card-body">
                            <div class="d-flex justify-content-center">
                                <div class="table-responsive" style="max-height: 500px; overflow-y: auto;">
