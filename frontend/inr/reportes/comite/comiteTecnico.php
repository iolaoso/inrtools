...
<body>
    ...
    <div class="d-flex">
        ...
        <main class="content p-3" id="main-content">
            <div class="row align-items-center mb-1">
                <h1 class="display-6 tituloPagina">COMITE TECNICO</h1>
                <p>Situación Actual de las Entidades del SFPS con relación a sus informes de Supervisión</p>
            </div>
    ...
    const carpetaReportes = 'assets/files/reportes/comite';
    </script>
